...
public class Message {
    ...
    public static final String CANNOT_REQUEST_MINIMUM_QUANTITY_EXECUTION_ORDER_IN_AUCTION_STATE = "Cannot request minimum quantity execution order when security is in Auction state";
